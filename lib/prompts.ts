...
- HARD CAP on total stitched length: IG 18-22s, YT 22-30s, FB 22-28s. NEVER exceed these. Shorter is almost always better.
...
- DO NOT just chunk the video into sequential 8-10 second segments. If your cuts read like 0:00—>0:08, 0:08—>0:18, 0:18—>0:28 — you got lazy. Restart. Pick from across the timeline, not in order.
...
- IG: fast, hook moment in first 1.5s, 3-4 punchy cuts of 3-5s each
- YT: setup-then-payoff arc. First cut establishes the place, last cut delivers the wow. 3-4 cuts of 4-7s
- FB: slightly looser, can lead with context. 3 cuts of 5-8s
